...
- [x] Pin reviewed Rust artifact `1.0.0-preview.4.25`, containing the complete unified role-event ABI and preserving
...
- [x] Set the default Rust artifact version to `1.0.0-preview.4.25`.
